...
<?php
	...
	$sql = mysqli_query($conn,"CALL selectidadminmenu('$term')"); 
			...
			echo "<td>".$row['Moduli']."</td>";

			
			echo "<td><a href=\"edit.php?id_menu=$row[id_menu]\">Edit</a> | <a href=\"delete.php?id_menu=$row[id_menu]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";			
		}
