...
<?php
	...
	$sql = mysqli_query($conn,"CALL selectvetterm('$term')"); 
	...
	while($row = mysqli_fetch_array($sql))		
			...
			echo "<td><a href=\"edit.php?ID_Veturat=$row[ID_Veturat]\">Edit</a> | <a href=\"delete.php?ID_Veturat=$row[ID_Veturat]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";			
		}
