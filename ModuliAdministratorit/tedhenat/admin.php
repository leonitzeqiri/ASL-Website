...
<?php
	...
	$sql = mysqli_query($conn,"CALL selectidadmintedhenat('$term')"); 

					
					while($row = mysqli_fetch_array($sql))		
					{ 
            echo "<tr>";				
			echo "<td>".$row['Pershkrimi1']."</td>";
			echo "<td>".$row['Pershkrimi2']."</td>";

			
			echo "<td><a href=\"edit.php?ID_tedhenat=$row[ID_tedhenat]\">Edit</a> | <a href=\"delete.php?ID_tedhenat=$row[ID_tedhenat]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";			
		}
