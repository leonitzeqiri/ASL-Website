...
<?php
	...
	$sql = mysqli_query($conn,"CALL selectidadminforma('$term')"); 
			...
			echo "<td><a href=\"edit.php?id_kontakti=$row[id_kontakti]\">Edit</a> | <a href=\"delete.php?id_kontakti=$row[id_kontakti]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";			
		}
