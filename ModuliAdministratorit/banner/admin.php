...
<?php
	...
	$sql = mysqli_query($conn,"CALL selectidadminbanner('$term')"); 
			...
			echo "<td>".$row['p1']."</td>";
			echo "<td>".$row['p2']."</td>";
            echo "<td><img src=data:image/jpeg;base64,".base64_encode($row['img_Data'])." width='80'  height='100'/></td>";
			echo "<td>".$row['headertitle']."</td>";
			echo "<td>".$row['titulli']."</td>";
			
			echo "<td><a href=\"edit.php?ID_headeri=$row[ID_headeri]\">Edit</a> | <a href=\"delete.php?ID_headeri=$row[ID_headeri]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";			
		}
