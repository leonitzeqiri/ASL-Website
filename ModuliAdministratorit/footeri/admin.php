...
<?php
	...
	$sql = mysqli_query($conn,"CALL selectidadminfooteri('$term')"); 
			...
			echo "<td><a href=\"edit.php?ID_footeri=$row[ID_footeri]\">Edit</a> | <a href=\"delete.php?ID_footeri=$row[ID_footeri]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";			
		}
